				...
				<div class="col-lg-6">
                    ...
                    <option>...</option>-->
								...
								<div class="col-12">
									...
									<select id="inputState" class="form-select"
										name="subCategoryId" value="${expenseBean.subCategoryId}">
										<%
                    ...
                    <option>...</option>-->
                                   <div class="col-12">
									...
									<select id="inputState" class="form-select"
										name="vendorId" value="${expenseBean.vendorId}">
										<%
                    ...
                    <option>...</option>-->
								<div class="col-12">
									...
									<select id="inputState" class="form-select"
										name="accountTypeId" value="${expenseBean.accountTypeId}">
										<%
                    ...
                    <option>...</option>-->
								...
								<div class="col-12">
									<label for="inputName5" class="form-label">Amount</label> <input
										type="text" class="form-control" id="inputName5" name="amount"
										value="${expenseBean.amount}">
								</div>
								<div class="col-12">
									<label for="inputName5" class="form-label">Date</label> <input
										type="date" class="form-control" id="inputName5" name="date"
										value="${expenseBean.date}">
								</div>
								<div class="col-12">
