...
//	int y = c.get(Calendar.YEAR);
	...
	public Integer getUsersCount() {
		String countUserQuery = "select count(*) from users where createdAt like ?";
...
//		getAmmountOfExpennseDaily asd = null;
		...
		String sumDailyExpenseQuery = "select sum(amount) from expense where date like ?";
	...
	public Integer getAmmountOfExpenseMonthly() {
		String sumMonthlyExpenseQuery = "select sum(amount) from expense where date like ?";
...
//Query
		String sumExpenseQuery = "select sum(amount) from expense where date like ?";
